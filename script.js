...
noButton.addEventListener("click", function() {
    ...
    switch (clickCount) {
        case 1:
            imageSrc = "images/shocked.gif"; // 震惊
            break;
        case 2:
            imageSrc = "images/think.gif";   // 思考
            break;
        case 3:
            imageSrc = "images/angry.gif";   // 生气
            break;
        case 4:
        case 5:
        default:
            imageSrc = "images/crying.gif";  // 哭（之后一直是哭）
            break;
    }
});
...
yesButton.addEventListener("click", function() {
    document.body.innerHTML = `
        <div class="yes-screen">
            <h1 class="yes-text">!!!超超超超超超级喜欢你!!!</h1>
